...
module.exports.handler = async(event,context)=>{
    ...
    //   console.log(`sub : ${subVal}`)
      ...
      if(userData){
        ...
        let cartData = await CartModel.find({userId:{ $eq:userId }}).populate("userId","-userName").populate("products.productId")
        ...
        if(cartData){
          ...
          return{
              statusCode: 200,
              body: JSON.stringify({msg:"This Cart is not exists"})
            }
      }
        else{
            return{
